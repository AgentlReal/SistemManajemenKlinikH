...
INSERT INTO `dokter` VALUES ('D001',1,'Dr. Ahmad Wijaya','1980-05-15',14000000,'081234567890','Penyakit Dalam','IDI-12345','Laki-laki','Jl. Merdeka No. 45, Jakarta',NULL),('D002',2,'Dr. Sari Dewi','1985-08-22',14500000,'081234567891','Kedokteran Gigi','IDI-12346','Perempuan','Jl. Melati No. 12, Jakarta',NULL),('D003',3,'Dr. Budi Santoso','1978-12-10',16000000,'081234567892','Anak','IDI-12347','Laki-laki','Jl. Kenanga No. 8, Jakarta',NULL),('D004',4,'Dr. Maya Sari','1982-03-25',15500000,'081234567893','Kulit dan Kelamin','IDI-12348','Perempuan','Jl. Anggrek No. 15, Jakarta',NULL),('D005',5,'Dr. Rudi Hermawan','1975-11-30',16500000,'081234567894','Mata','IDI-12349','Laki-laki','Jl. Mawar No. 20, Jakarta',NULL),('D006',1,'Dr. Hendra Kurniawan','1979-03-18',17500000,'081298765432','Kardiologi','IDI-12370','Laki-laki','Jl. Jantung Sehat No. 15, Jakarta',NULL);
...
INSERT INTO `jadwal_karyawan` VALUES (1,'R001',NULL,NULL,NULL,'00:00:00','23:59:00',1,1,1,1,1,1,1,NULL),(2,'R002',NULL,NULL,NULL,'08:00:00','16:00:00',1,1,1,1,1,1,1,NULL),(3,'R003',NULL,NULL,NULL,'13:00:00','21:00:00',1,1,1,1,1,1,1,NULL),(4,NULL,'D001',NULL,NULL,'08:00:00','23:59:00',1,1,1,1,1,1,1,NULL),(5,NULL,'D002',NULL,NULL,'09:00:00','13:00:00',1,1,1,1,1,1,1,NULL),(6,NULL,'D003',NULL,NULL,'10:00:00','14:00:00',1,1,1,1,1,1,1,NULL),(7,NULL,'D004',NULL,NULL,'07:00:00','23:59:00',1,1,1,1,1,1,1,NULL),(8,NULL,'D005',NULL,NULL,'14:00:00','18:00:00',1,1,1,1,1,1,1,NULL),(9,NULL,NULL,'L001',NULL,'07:30:00','15:30:00',1,1,1,1,1,1,1,NULL),(10,NULL,NULL,'L002',NULL,'08:00:00','16:00:00',1,1,1,1,1,1,1,NULL),(11,NULL,NULL,'L003',NULL,'13:00:00','21:00:00',1,1,1,1,1,1,1,NULL),(12,NULL,NULL,NULL,'K001','07:00:00','15:00:00',1,1,1,1,1,1,1,'2025-12-07 02:06:34'),(13,NULL,NULL,NULL,'K002','08:00:00','16:00:00',1,1,1,1,1,1,1,NULL),(14,NULL,NULL,NULL,'K003','13:00:00','21:00:00',1,1,1,1,1,1,1,NULL),(15,NULL,'D006',NULL,NULL,'08:00:00','17:00:00',1,1,1,1,1,1,1,NULL);
...
INSERT INTO `kasir` VALUES ('K001','Fajar Setiawan','1993-11-20','081567890123','Jl. Sakura No. 22, Jakarta',3000000,'Laki-laki',NULL),('K002','Gita Permata','1994-08-15','081567890124','Jl. Lavender No. 23, Jakarta',5400000,'Perempuan',NULL),('K003','Hendra Gunawan','1992-12-08','081567890125','Jl. Dahlia No. 25, Jakarta',5600000,'Laki-laki',NULL);
...
INSERT INTO `pasien` VALUES (1,'3273011501990001','Andi Susanto','081678901234','Laki-laki','1980-01-09','Jl. Mangga No. 10, Jakarta',NULL),(2,'3273012207850002','Siti Rahayu Kusnowo','081678901235','Perempuan','1985-07-22','Jl. Jeruk No. 12, Jakarta',NULL),(3,'3273013003920003','Budi Prasetyo Suparman','081678901236','Laki-laki','1992-03-30','Jl. Apel No. 14, Jakarta',NULL),(4,'3273011811880004','Maya Kusnowo','081678901237','Perempuan','1988-11-05','Jl. Durian No. 16, Jakarta',NULL),(5,'3273010509950005','Rina Wati','081678901238','Perempuan','1995-09-18','Jl. Rambutan No. 18, Jakarta',NULL),(6,'3273012512800006','Joko Widodo','081678901239','Laki-laki','1980-12-25','Jl. Salak No. 20, Jakarta',NULL),(7,'3273011406930007','Dewi Anggraini','081678901240','Perempuan','1993-06-14','Jl. Semangka No. 22, Jakarta',NULL),(8,'3273010804870008','Eko Pratama','081678901241','Laki-laki','1987-04-08','Jl. Melon No. 24, Jakarta',NULL),(9,'3273012410020009','Bintang Sukidi','08123434332','Laki-laki','2002-10-24','Jalan Surabaya',NULL),(11,'3273011505900010','Budi Santoso','081234567890','Laki-laki','1990-05-15','Jl. Contoh No. 123',NULL),(12,'3201012345670323','Juan Pratama','081234567430','Laki-laki','2001-11-06','456 Oak Ave, Bandung',NULL),(13,'3273011501990067','Naufal Pratama Wijaya','081678907563','Laki-laki','2005-11-09','Jl. Harapan 2, Sidoarjo',NULL),(14,'3273012410020032','Firman Praka Suparman','081678901298','Laki-laki','2002-08-28','Jalan Surabaya No. 12',NULL),(15,'3273011501990054','Hotasi Abednego','081678901265','Laki-laki','2005-03-08','Jalan Semarang No.5',NULL),(16,'3273011501990087','Oki Prasetyo','081678901267','Perempuan','2010-12-13','126 Main St, Jakarta',NULL),(17,'3273012410020056','ijat jarjit','081234567807','Laki-laki','2008-12-08','789 Pine Rd, Gresik',NULL);
...
INSERT INTO `poli` VALUES (1,'Umum',NULL),(2,'Gigi',NULL),(3,'Anak',NULL),(4,'Kulit',NULL),(5,'Mata',NULL);
...
INSERT INTO `resepsionis` VALUES ('R001','Dewi Lestari Septi','1990-06-12',7000000,'081345678901','Perempuan','Jl. Flamboyan No. 4, Jakarta',NULL),('R002','Rina Andriani','1992-09-18',5800000,'081345678902','Perempuan','Jl. Cendana No. 7, Jakarta',NULL),('R003','Ari Pratama','1991-03-25',5900000,'081345678903','Laki-laki','Jl. Teratai No. 9, Jakarta',NULL),('R004','Bintang Al Asror','1993-11-19',6000000,'081345678943','Laki-laki','Jl. Flamboyan No. 5, Surabaya',NULL);
...
INSERT INTO `staf_lab` VALUES ('L001','Bambang Sutrisno','1988-07-14','081456789012',7500000,'Jl. Kamboja No. 11, Jakarta','PAM-56789','Laki-laki',NULL),('L002','Citra Ayu','1990-11-28','081456789013',7300000,'Jl. Seroja No. 13, Jakarta','PAM-56790','Perempuan',NULL),('L003','Dedi Kurniawan','1987-04-05','081456789014',7400000,'Jl. Tulip No. 17, Jakarta','PAM-56791','Laki-laki',NULL);
...
INSERT INTO `tarif_layanan` VALUES (1,'Dokter',200000,'Konsultasi Umum',NULL),(2,'Dokter',200000,'Konsultasi Spesialis',NULL),(3,'Laboratorium',75000,'Pemeriksaan Darah Lengkap',NULL),(4,'Laboratorium',50000,'Pemeriksaan Urin',NULL),(5,'Laboratorium',120000,'Pemeriksaan Kolesterol',NULL),(6,'Laboratorium',100000,'Pemeriksaan Gula Darah',NULL),(7,'Dokter',300000,'Tindakan Minor',NULL),(8,'Dokter',500000,'Tindakan Sedang',NULL),(9,'Administrasi',5000,'Biaya Admin',NULL);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_dokter_lengkap` AS select `d`.`id_dokter` AS `id_dokter`,`d`.`id_poli` AS `id_poli`,`p`.`nama_poli` AS `nama_poli`,`d`.`nama` AS `nama_dokter`,`d`.`tanggal_lahir` AS `tanggal_lahir`,`d`.`gaji` AS `gaji`,`d`.`nomor_telepon` AS `nomor_telepon`,`d`.`spesialis` AS `spesialis`,`d`.`nomor_lisensi` AS `nomor_lisensi`,`d`.`jenis_kelamin` AS `jenis_kelamin`,`d`.`alamat` AS `alamat` from (`dokter` `d` left join `poli` `p` on((`d`.`id_poli` = `p`.`id_poli`))) where (`d`.`deleted_at` is null) order by `d`.`id_dokter` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_jadwal_karyawan_lengkap` AS select `jk`.`id_jadwal` AS `id_jadwal`,'Resepsionis' AS `jenis_karyawan`,`r`.`id_resepsionis` AS `id_karyawan`,`r`.`nama` AS `nama_karyawan`,NULL AS `spesialis`,NULL AS `nomor_lisensi`,`jk`.`senin` AS `senin`,`jk`.`selasa` AS `selasa`,`jk`.`rabu` AS `rabu`,`jk`.`kamis` AS `kamis`,`jk`.`jumat` AS `jumat`,`jk`.`sabtu` AS `sabtu`,`jk`.`minggu` AS `minggu`,`jk`.`jam_mulai` AS `jam_mulai`,`jk`.`jam_selesai` AS `jam_selesai`,`r`.`jenis_kelamin` AS `jenis_kelamin`,`r`.`nomor_telepon` AS `nomor_telepon` from (`jadwal_karyawan` `jk` join `resepsionis` `r` on((`jk`.`id_resepsionis` = `r`.`id_resepsionis`))) where ((`jk`.`id_resepsionis` is not null) and (`jk`.`deleted_at` is null)) union all select `jk`.`id_jadwal` AS `id_jadwal`,'Dokter' AS `jenis_karyawan`,`d`.`id_dokter` AS `id_karyawan`,`d`.`nama` AS `nama_karyawan`,`d`.`spesialis` AS `spesialis`,`d`.`nomor_lisensi` AS `nomor_lisensi`,`jk`.`senin` AS `senin`,`jk`.`selasa` AS `selasa`,`jk`.`rabu` AS `rabu`,`jk`.`kamis` AS `kamis`,`jk`.`jumat` AS `jumat`,`jk`.`sabtu` AS `sabtu`,`jk`.`minggu` AS `minggu`,`jk`.`jam_mulai` AS `jam_mulai`,`jk`.`jam_selesai` AS `jam_selesai`,`d`.`jenis_kelamin` AS `jenis_kelamin`,`d`.`nomor_telepon` AS `nomor_telepon` from (`jadwal_karyawan` `jk` join `dokter` `d` on((`jk`.`id_dokter` = `d`.`id_dokter`))) where ((`jk`.`id_dokter` is not null) and (`jk`.`deleted_at` is null)) union all select `jk`.`id_jadwal` AS `id_jadwal`,'Staf Lab' AS `jenis_karyawan`,`sl`.`id_staf_lab` AS `id_karyawan`,`sl`.`nama` AS `nama_karyawan`,NULL AS `spesialis`,`sl`.`nomor_lisensi` AS `nomor_lisensi`,`jk`.`senin` AS `senin`,`jk`.`selasa` AS `selasa`,`jk`.`rabu` AS `rabu`,`jk`.`kamis` AS `kamis`,`jk`.`jumat` AS `jumat`,`jk`.`sabtu` AS `sabtu`,`jk`.`minggu` AS `minggu`,`jk`.`jam_mulai` AS `jam_mulai`,`jk`.`jam_selesai` AS `jam_selesai`,`sl`.`jenis_kelamin` AS `jenis_kelamin`,`sl`.`nomor_telepon` AS `nomor_telepon` from (`jadwal_karyawan` `jk` join `staf_lab` `sl` on((`jk`.`id_staf_lab` = `sl`.`id_staf_lab`))) where ((`jk`.`id_staf_lab` is not null) and (`jk`.`deleted_at` is null)) union all select `jk`.`id_jadwal` AS `id_jadwal`,'Kasir' AS `jenis_karyawan`,`k`.`id_kasir` AS `id_karyawan`,`k`.`nama` AS `nama_karyawan`,NULL AS `spesialis`,NULL AS `nomor_lisensi`,`jk`.`senin` AS `senin`,`jk`.`selasa` AS `selasa`,`jk`.`rabu` AS `rabu`,`jk`.`kamis` AS `kamis`,`jk`.`jumat` AS `jumat`,`jk`.`sabtu` AS `sabtu`,`jk`.`minggu` AS `minggu`,`jk`.`jam_mulai` AS `jam_mulai`,`jk`.`jam_selesai` AS `jam_selesai`,`k`.`jenis_kelamin` AS `jenis_kelamin`,`k`.`nomor_telepon` AS `nomor_telepon` from (`jadwal_karyawan` `jk` join `kasir` `k` on((`jk`.`id_kasir` = `k`.`id_kasir`))) where ((`jk`.`id_kasir` is not null) and (`jk`.`deleted_at` is null)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_karyawan_tanpa_jadwal` AS select 'Dokter' AS `jenis_karyawan`,`d`.`id_dokter` AS `id_karyawan`,`d`.`nama` AS `nama_karyawan`,`d`.`spesialis` AS `spesialis`,`p`.`nama_poli` AS `unit_kerja`,`d`.`nomor_telepon` AS `nomor_telepon`,`d`.`jenis_kelamin` AS `jenis_kelamin`,NULL AS `jabatan_lainnya` from (`dokter` `d` join `poli` `p` on((`d`.`id_poli` = `p`.`id_poli`))) where (`d`.`id_dokter` in (select distinct `jadwal_karyawan`.`id_dokter` from `jadwal_karyawan` where ((`jadwal_karyawan`.`id_dokter` is not null) and (`jadwal_karyawan`.`deleted_at` is null))) is false and (`d`.`deleted_at` is null)) union all select 'Resepsionis' AS `jenis_karyawan`,`r`.`id_resepsionis` AS `id_karyawan`,`r`.`nama` AS `nama_karyawan`,NULL AS `spesialis`,'Front Office' AS `unit_kerja`,`r`.`nomor_telepon` AS `nomor_telepon`,`r`.`jenis_kelamin` AS `jenis_kelamin`,NULL AS `jabatan_lainnya` from `resepsionis` `r` where (`r`.`id_resepsionis` in (select distinct `jadwal_karyawan`.`id_resepsionis` from `jadwal_karyawan` where ((`jadwal_karyawan`.`id_resepsionis` is not null) and (`jadwal_karyawan`.`deleted_at` is null))) is false and (`r`.`deleted_at` is null)) union all select 'Staf Lab' AS `jenis_karyawan`,`sl`.`id_staf_lab` AS `id_karyawan`,`sl`.`nama` AS `nama_karyawan`,NULL AS `spesialis`,'Laboratorium' AS `unit_kerja`,`sl`.`nomor_telepon` AS `nomor_telepon`,`sl`.`jenis_kelamin` AS `jenis_kelamin`,`sl`.`nomor_lisensi` AS `jabatan_lainnya` from `staf_lab` `sl` where `sl`.`id_staf_lab` in (select distinct `jadwal_karyawan`.`id_staf_lab` from `jadwal_karyawan` where ((`jadwal_karyawan`.`id_staf_lab` is not null) and (`jadwal_karyawan`.`deleted_at` is null))) is false union all select 'Kasir' AS `jenis_karyawan`,`k`.`id_kasir` AS `id_karyawan`,`k`.`nama` AS `nama_karyawan`,NULL AS `spesialis`,'Administrasi' AS `unit_kerja`,`k`.`nomor_telepon` AS `nomor_telepon`,`k`.`jenis_kelamin` AS `jenis_kelamin`,NULL AS `jabatan_lainnya` from `kasir` `k` where `k`.`id_kasir` in (select distinct `jadwal_karyawan`.`id_kasir` from `jadwal_karyawan` where ((`jadwal_karyawan`.`id_kasir` is not null) and (`jadwal_karyawan`.`deleted_at` is null))) is false */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-12-07 17:07:24
